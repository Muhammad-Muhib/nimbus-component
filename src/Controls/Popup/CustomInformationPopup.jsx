...
export default function CustomInformationPopup({
  setShowModal,
  onConfirm,
  modalBody,
  modalTitle,
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div
            ...
            style={{
              backgroundColor: headerColor == "" ? "#3f4d54" : headerColor,
            }}
          >
          ...
          <div className="modal-footer">
            <button
              ...
              style={{
                backgroundColor: btnColor == "" ? "black" : btnColor,
                borderColor: btnColor == "" ? "black" : btnColor,
              }}
              id="okBtn"

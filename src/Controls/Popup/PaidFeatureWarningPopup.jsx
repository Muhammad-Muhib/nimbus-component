          ...
          <div className="pfw-title">
            <span className="pfw-warning">
              ...
              <span className="pfw-subtext">
                ...
                <span
                  className={`pfw-date ${
                    dateColor == "green" ? "pfw-date-green" : "pfw-date-red"
                  }`}
                >
                  {" "}
                  {newExpiryDate}
              ...
              <div className="pfw-panel pfw-current">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <b>
                      {thousandformater(
                        formatCurrency(beforeTrans.totalCost / 30)
                      )}
                    </b>
                  </li>
                  <li>
                    ...
                    <b>
                      {thousandformater(formatCurrency(beforeTrans.totalCost))}
                    </b>
                  </li>
                </ul>
              </div>
              ...
              <div className="pfw-panel pfw-new">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <b>
                      {thousandformater(
                        formatCurrency(afterTrans.totalCost / 30)
                      )}
                    </b>
                  </li>
                  <li>
                    ...
                    <b>
                      {thousandformater(formatCurrency(afterTrans.totalCost))}
                    </b>
                  </li>
                </ul>
              </div>

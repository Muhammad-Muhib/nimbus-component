...
export default function LeftMenuList(props) {
  ...
  return (
    <ul className="scoop-item scoop-left-item" style={ props.showLeftMenu ? {maxHeight: "78%"} : {maxHeight: "100%"}}> 
          ...
          <li className="active"><Link className="navLink listLink subLink" to="/app/SalesRegister"><span className="scoop-micon"></span><span className="scoop-mtext list-text">Sales Register</span></Link></li>
